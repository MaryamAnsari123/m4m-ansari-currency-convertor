...
document.getElementById('converter-form')?.addEventListener('submit', function(e) {
    ...
    let fromCurrency = (document.getElementById('from') as HTMLInputElement).value;
    let toCurrency = (document.getElementById('to') as HTMLInputElement).value;
    let amount = parseFloat((document.getElementById('amount') as HTMLInputElement).value);
